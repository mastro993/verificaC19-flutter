...
class _ApiClient implements ApiClient {
  ...
  Future<HttpResponse<List<ValidationRule>>> getValidationRules() async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<HttpResponse<List<ValidationRule>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<CRLStatus>> getCRLStatus({version}) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<CRLStatus>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<CRL>> getCRL({
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<HttpResponse<CRL>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
