...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i3.ExemptionValidator>(() => _i4.ExemptionValidatorImpl(),
      registerFor: {_prod});
  ...
  gh.factory<_i7.RecoveryStatementValidator>(
      ...
      registerFor: {_prod});
  gh.singleton<_i9.RemoteRepository>(_i10.RemoteRepositoryImpl.create(),
      registerFor: {_prod});
  ...
  gh.lazySingleton<_i13.Updater>(
      () => _i14.UpdaterImpl(
          get<_i9.RemoteRepository>(), get<_i5.LocalRepository>()),
      registerFor: {_prod});
