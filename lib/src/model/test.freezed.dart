...
abstract class $TestCopyWith<$Res> {
  ...
  $Res call(
      ...
      DateTime dateTimeOfCollection,
      DateTime? dateTimeOfTestResult,
      String testResult,
...
class _$_Test extends _Test {
  const _$_Test(
      ...
      required this.testNameAndManufacturer,
      required this.dateTimeOfCollection,
      required this.dateTimeOfTestResult,
  ...
  @override
  String toString() {
    return 'Test(disease: $disease, typeOfTest: $typeOfTest, testName: $testName, testNameAndManufacturer: $testNameAndManufacturer, dateTimeOfCollection: $dateTimeOfCollection, dateTimeOfTestResult: $dateTimeOfTestResult, testResult: $testResult, testingCentre: $testingCentre, countryOfVaccination: $countryOfVaccination, certificateIssuer: $certificateIssuer, certificateIdentifier: $certificateIdentifier)';
  }
