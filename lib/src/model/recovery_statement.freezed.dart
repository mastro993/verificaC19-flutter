...
mixin _$RecoveryStatement {
  ...
  @JsonKey(ignore: true)
  $RecoveryStatementCopyWith<RecoveryStatement> get copyWith =>
...
class _$_RecoveryStatement extends _RecoveryStatement {
  const _$_RecoveryStatement(
  ...
  @override
  String toString() {
    return 'RecoveryStatement(disease: $disease, dateOfFirstPositiveTest: $dateOfFirstPositiveTest, certificateValidFrom: $certificateValidFrom, certificateValidUntil: $certificateValidUntil, countryOfVaccination: $countryOfVaccination, certificateIssuer: $certificateIssuer, certificateIdentifier: $certificateIdentifier)';
  }
